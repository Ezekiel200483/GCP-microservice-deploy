...
4. Create a GKE cluster and get the credentials for it.
   ...
   ![1726272767118](image/README/1726272767118.png)
...
![1726272560142](image/README/1726272560142.png)


1. Congrats! You've deployed the default Online Boutique. To deploy a different variation of Online Boutique (e.g., with Google Cloud Operations tracing, Istio, etc.), see [Deploy Online Boutique variations with Kustomize](#deploy-online-boutique-variations-with-kustomize).
